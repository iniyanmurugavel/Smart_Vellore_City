...
public class Activity_IncomeCertificate extends AppCompatActivity implements View.OnClickListener {
    MaterialEditText salary_et,rationCard_et,signature_et,date_et;
    Button submit;
    @Override
            ...
            case R.id.submit_btn:
                ...
                sdialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        Activity_IncomeCertificate.this.finish();
                    }
                });
                sdialog.show();
                break;
