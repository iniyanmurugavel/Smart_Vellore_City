...
public class Activity_NativityCertificate extends AppCompatActivity implements View.OnClickListener {
    MaterialEditText salary_et,rationCard_et,signature_et,date_et,schoolcert_et;
    Button submit;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nativity_certificate);
            ...
            case R.id.submit_btn:
                ...
                sdialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        Activity_NativityCertificate.this.finish();
                    }
                });
                sdialog.show();
                break;
