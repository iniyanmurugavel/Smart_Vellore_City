...
public class FutureUseAdapterGas extends RecyclerView.Adapter<FutureUseAdapterGas.ViewHolder>{
    Context context;
    ...
    public FutureUseAdapterGas(Context context, ArrayList<FutureListBean> futureListBean){
    ...
    @Override
    public FutureUseAdapterGas.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.future_row_recycler_gas,parent,false);
        return new FutureUseAdapterGas.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FutureUseAdapterGas.ViewHolder holder, final int position) {
        ...
        holder.brd_name.setText("Gas Provider");

        holder.mylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                GasBill ebBill = (GasBill) context;
                ebBill.etGasProvider.setText(futureListBean.get(position).getConsumerBoard());
