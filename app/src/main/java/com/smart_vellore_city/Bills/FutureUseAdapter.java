...
public class FutureUseAdapter extends RecyclerView.Adapter<FutureUseAdapter.ViewHolder>{
    Context context;
    ...
    public FutureUseAdapter(Context context, ArrayList<FutureListBean> futureListBean){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.future_row_recycler,parent,false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.brd_name.setText("Electricity Board");

        holder.mylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EBBill ebBill = (EBBill)context;
                ebBill.etEBoard.setText(futureListBean.get(position).getConsumerBoard());
